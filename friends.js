...
router.post("/",(req,res)=>{
  ...
  res.send(`Friend ${req.body.firstName} has been added! `)//This line is to be replaced with actual return value
});
...
router.delete("/:email", (req, res) => {
  ...
  res.send(`Friend with email ${email} has been deleted!`)//This line is to be replaced with actual return value
});
